...
const Socials = [
  ...
  {
    name: 'GitHub',
    url: 'https://github.com/SugamChaudharry',
    icon: FaGithub,
  },
  {
    name: 'Twitter',
    url: 'https://x.com/SugamChaudharry',
    ...
    >
      ...
      <div className="mt-8 flex flex-col ">
        ...
        <ul className="mt-2 flex flex-col gap-2 list-disc list-inside text-base tracking-tight">
          <li>
            Hi, I am Sugam Chaudhary, a Full-stack Developer passionate about
